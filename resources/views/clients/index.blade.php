    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex space-x-4">
                <input type="text" placeholder="Search by name" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            ...
            <table class="min-w-full table-auto">
                ...
                @foreach ($clients as $client)
                    <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-800">{{ $client->full_name }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800">{{ $client->email }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800">{{ $client->phone }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800">{{ $client->status }}</td>
